...
urlpatterns = [
    ...
    path("edit_owner_profile/<int:id>/", views.edit_owner_profile_view, name="edit_owner_profile"),
    path("edit_tenant_profile/<int:id>/", views.edit_tenant_profile_view, name="edit_tenant_profile"),
